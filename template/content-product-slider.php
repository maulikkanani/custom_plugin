        ...
        <div class="products_slider_infos">
            ...
            <div class="products_slider_button_wrapper">
                ...
                <?php if ( ! $product->is_in_stock() ) : ?>
                    ...
                    <a class="dark_button" href="<?php echo apply_filters( 'out_of_stock_add_to_cart_url', get_permalink( $product->id ) ); ?>"><?php echo apply_filters( 'out_of_stock_add_to_cart_text', __( 'Read More', 'theretailer' ) ); ?></a>
                    ...
                    <?php
                        ...
                        switch ( $product->product_type ) {
                            case "variable" :
                                ...
                                $label 	= apply_filters( 'variable_add_to_cart_text', __('Select options', 'theretailer') );
                            break;
                            case "grouped" :
                                $link 	= apply_filters( 'grouped_add_to_cart_url', get_permalink( $product->id ) );
                                $label 	= apply_filters( 'grouped_add_to_cart_text', __('View options', 'theretailer') );
                            break;
                            case "external" :
                                $link 	= apply_filters( 'external_add_to_cart_url', get_permalink( $product->id ) );
                                $label 	= apply_filters( 'external_add_to_cart_text', __('Read More', 'theretailer') );
                            break;
                            default :
                                $link 	= apply_filters( 'add_to_cart_url', esc_url( $product->add_to_cart_url() ) );
                                $label 	= apply_filters( 'add_to_cart_text', __('Add to shopping bag', 'theretailer') );
                            break;
                        }
