...
get_header('shop'); ?>
	...
	<div class="global_content_wrapper">
		...
		<div data-stellar-background-ratio="0.5" class="category_header <?php if ( $description ) : ?>with_term_description<?php endif; ?> <?php if ($category_header_src != "") : ?>with_featured_img<?php endif; ?>" style="background-image:url(<?php echo $category_header_src ; ?>)">
