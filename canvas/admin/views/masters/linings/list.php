...
include ABS_WCA . "admin/views/masters/linings/grid.php";
...
if ($Buttons_grid->current_action() == 'dodelete'):
     if($_POST['delete_option']=='delete'){
             ...
             wca_lining::delete_multiple($zipper_ids);
     }
...
if ($Buttons_grid->current_action() == 'edit'):
    ...
    <?php
    $zipper_id = mysql_real_escape_string($_GET['id']);
    $data = wca_lining::get_single_row($zipper_id);
    $form_button = 'Update';
    $default_values = json_encode($data);
    include ABS_WCA . "admin/views/masters/linings/add.php";
    exit;
endif;
...
if ($Buttons_grid->current_action() == "image_add") {
    include ABS_WCA . "admin/views/masters/linings/image_add.php";
    exit;
}
...
if ($Buttons_grid->current_action()== 'delete'){
    include ABS_WCA . "admin/views/masters/linings/delete.php";
    exit;
}
/*End:- delete form */
?>
