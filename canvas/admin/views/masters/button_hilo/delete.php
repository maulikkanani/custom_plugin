...
if (!defined('ABSPATH'))
            ...
            <form action="" method="post" name="deletesingle" id="deletesingle">
                <div class="wrap">
                    ...
                    <p><?php echo _n('You have specified this Button for deletion:', 'Please check the Button hilo:', count($id)); ?></p>
                    <ul>
                        <?php
                        foreach ($ids as $id):
                            $id = (int) $id;
                    ...
                    <?php if ($id) : ?>
                        <fieldset><p><legend><?php echo _n('Are you sure to delete this Button hilo?', 'Are you sure to delete this Button hilo?', $go_delete); ?></legend></p>
