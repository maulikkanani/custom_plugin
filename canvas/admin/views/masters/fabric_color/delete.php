...
if (!defined('ABSPATH'))
            ...
            <form action="" method="post" name="deletesingle" id="deletesingle">
                <div class="wrap">
                    ...
                    <h2><?php _e('Delete Fabric color'); ?></h2>
                    <p><?php echo _n('You have specified this Fabric color for deletion:', 'Please check the Fabric color:', count($id)); ?></p>
                    <ul>
                        <?php
                        foreach ($ids as $id):
                            $id = (int) $id;
                    ...
                    <?php if ($id) : ?>
                        <fieldset><p><legend><?php echo _n('Are you sure to delete this Fabric color?', 'Are you sure to delete this Fabric color?', $go_delete); ?></legend></p>
                            <ul style="list-style:none;">
                                <li>
                                    <label>
                                        <input type="radio" id="delete_option0" name="delete_option" value="delete" />
                                        <?php _e('Delete Fabric color.'); ?>
                                    </label>
                                </li>
                                <li>
                                    <label>
                        ...
                        ?>
                        <p><?php _e('There are no valid Fabric color selected for deletion.'); ?></p>
                    <?php endif; ?>
                </div>
            </form>
            <?php
