...
if (!defined('ABSPATH'))
            ...
            <form action="" method="post" name="deletesingle" id="deletesingle">
                <div class="wrap">
                    ...
                    <h2><?php _e('Delete Button'); ?></h2>
                    <p><?php echo _n('You have specified this Button for deletion:', 'Please check the Elbow Patches:', count($id)); ?></p>
                    <ul>
                        <?php
                        foreach ($ids as $id):
                            $id = (int) $id;
                    ...
                    <?php if ($id) : ?>
                        <fieldset><p><legend><?php echo _n('Are you sure to delete this Elbow patch?', 'Are you sure to delete this Elbow patch?', $go_delete); ?></legend></p>
                        ...
                        ?>
                        <p><?php _e('There are no valid Button selected for deletion.'); ?></p>
                    <?php endif; ?>
                </div>
            </form>
            <?php
