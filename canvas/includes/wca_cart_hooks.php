...
class wca_cart_hooks {
    ...
    function wca_in_cart_product_thumbnail($thumb, $cart_item, $cart_item_key) {
        ...
        if (isset($cart_item['wca_cart_data'])) {
            ...
            <div class="col-xs-12 col-sm-12 wca-cart-thumb">
                ...
                $front_id=$unique_class.'_front_mini';
                $back_id=$unique_class.'_back_mini';
                $canvas_width=120;
                $canvas_height=150;
                $size=0.2;
    ...
    function wca_in_mini_cart_product_thumbnail($thumb, $cart_item, $cart_item_key) {
        ...
        if (isset($cart_item['wca_cart_data'])) {
            ...
            <div class="col-xs-12 col-sm-12 wca-cart-thumb">
                ...
                $front_id=$unique_class.'_front_thumb';
                $back_id=$unique_class.'_back_thumb';
                $canvas_width=120;
                $canvas_height=150;
                $size=0.2;
    ...
    public function wca_product_detail() {
        ...
        $front_id=$unique_class.'_front_det';
        $back_id=$unique_class.'_back_det';
        $canvas_width=400;
        $canvas_height=600;
        $size=0.8; 
