...
<script type="text/javascript">
    ...
    $view_fabric = $default_attrs.wca_trenchcoat_fabric_type;


    $viwe_fabric_data = jQuery.parseJSON('<?php echo $view_fabric_data ?>');
    $view_fabric_color = $viwe_fabric_data[$view_fabric].color;
    $view_buttons = $viwe_fabric_data[$view_fabric].button;
    $view_zipper = $viwe_fabric_data[$view_fabric].zipper;

    var blank_image = '<?php echo $blank_image ?>';
    var cat_url = '<?php echo $view_image_category ?>';
    var image_front_url = cat_url + '/fabric_color/' + $view_fabric_color + '/front';
    var image_back_url = cat_url + '/fabric_color/' + $view_fabric_color + '/back';
    var button_url = cat_url + '/botones/' + $view_buttons;
    var zipper_url = cat_url + '/zipper/' + $view_zipper;
    var linig_url = cat_url + '/linings';
    var category = '<?php echo $view_category ?>';
