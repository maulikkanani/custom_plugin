...
CREATE TABLE IF NOT EXISTS `wp_wca_attr_lable` (
  ...
  `cart_variable` enum('0','1') NOT NULL DEFAULT '0' COMMENT ')= this attribute have not a price, 1= attribute have a price',
  PRIMARY KEY (`id`)
...
INSERT INTO `wp_wca_attr_lable` (`id`, `attr_name`, `value`, `lable`, `category_id`, `price`, `cart_variable`) VALUES
(9, 'wca_trenchcoat_style', 'crossed', 'Double breasted', 1, 1, '1'),
(14, 'wca_trenchcoat_style', 'simple', 'Single breasted ', 1, 1, '1'),
(15, 'wca_trenchcoat_length', 'short', 'Short', 1, 0, '1'),
(34, 'wca_trenchcoat_fit', '0', 'Straight', 1, 0, '1'),
(35, 'wca_trenchcoat_closure', 'boton', 'Button', 1, 0, '1'),
(38, 'wca_trenchcoat_length', 'long', 'Long', 1, 1, '1'),
(39, 'wca_trenchcoat_fit', '1', 'Waisted ', 1, 0, '1'),
(40, 'wca_trenchcoat_closure', 'zipper', 'Zipper', 1, 0, '1'),
(41, 'wca_trenchcoat_closure_type_boton', 'standard', 'Standard', 1, 0, '1'),
(42, 'wca_trenchcoat_pockets', '3', '3 Pocket', 1, 0, '1'),
(43, 'wca_trenchcoat_pockets', '2', '2 Pocket', 1, 0, '1'),
(44, 'wca_trenchcoat_pockets', '0', 'No Pocket', 1, 0, '1'),
(45, 'wca_trenchcoat_closure_type_boton', 'hide', 'Hidden', 1, 0, '1'),
(46, 'wca_trenchcoat_chest_pocket', 'patched', 'Patched', 1, 0, '1'),
(47, 'wca_trenchcoat_chest_pocket', 'zipper', 'Zipper', 1, 0, '1'),
(48, 'wca_trenchcoat_chest_pocket', 'vertical', 'Vertical', 1, 0, '1'),
(49, 'wca_trenchcoat_chest_pocket', 'welt', 'Welt', 1, 0, '1'),
(50, 'wca_trenchcoat_chest_pocket', '0', 'No', 1, 0, '1'),
(51, 'wca_trenchcoat_belt', 'loose', 'Loose', 1, 0, '1'),
(52, 'wca_trenchcoat_belt', 'sewing', 'Sewed', 1, 0, '1'),
(53, 'wca_trenchcoat_belt', '0', 'No', 1, 0, '1'),
(54, 'wca_trenchcoat_backcut', '2', 'Side vents', 1, 0, '1'),
(55, 'wca_trenchcoat_backcut', '1', 'Center vent', 1, 0, '1'),
(56, 'wca_trenchcoat_backcut', '0', 'Ventless', 1, 0, '1'),
(57, 'wca_trenchcoat_sleeve', 'button', 'Buttons ', 1, 0, '1'),
(58, 'wca_trenchcoat_sleeve', 'tape', 'Tape', 1, 0, '1'),
(59, 'wca_trenchcoat_sleeve', '0', 'No ', 1, 0, '1'),
(60, 'wca_trenchcoat_shoulder', '0', 'No ', 1, 0, '1'),
(61, 'wca_trenchcoat_back_lapel', '0', 'No', 1, 0, '1'),
(62, 'wca_trenchcoat_shoulder', '1', 'With ribbon', 1, 0, '1'),
(64, 'wca_trenchcoat_back_lapel', '1', 'Yes', 1, 0, '1'),
(65, 'wca_trenchcoat_interior_type', '0', 'Color by default', 1, 0, '0'),
(66, 'wca_trenchcoat_interior_type', '1', 'Custom Colors', 1, 0, '0'),
(67, 'customize_trench_coat_lining', '', 'Customize Trench Coat Linings', 1, 0, '0'),
(68, 'wca_embroidery', '1', 'Add Embroidery', 1, 9.55, '1'),
(69, 'wca_neck_lining', '1', 'Neck Linings', 1, 3, '1'),
(70, 'wca_trenchcoat_neck_lapel', '0', 'Color by default', 1, 0, '0'),
(71, 'wca_trenchcoat_neck_lapel', '1', 'Custom Colors', 1, 0, '0'),
(72, 'wca_elbow_patch', '1', 'Add elbow patches ', 1, 12, '1'),
(73, 'wca_trenchcoat_elbow_patch', '0', 'No elbow patches', 1, 0, '0'),
(74, 'wca_trenchcoat_elbow_patch', '1', 'Add elbow patches', 1, 0, '0'),
(75, 'wca_button_hilo_ojal', '1', 'Add colored button holes / threads', 1, 3, '1'),
(76, 'wca_trenchcoat_btn_thread_apply', 'all', 'All', 1, 0, '0'),
(77, 'wca_trenchcoat_btn_thread_apply', 'cuff', 'Cuffs Only', 1, 0, '0');
