        ...
        <div class="extras_product_preview_box">
          ...
          <div class="extras_right">
            ...
            <div class="extra_box">
              ...
              <?php } else{ 
                  $linings = $current_items['wca_trenchcoat_interior']; 
                  ?>
              <div class="extra_img">
            ...
            <div class="extra_box">
              <div class="extra_description">
                <p><span class="label_initials">Embroiders : </span><span><?php echo $current_items['wca_embroidery_text']; ?></span></p>
                <p><span class="label_initials">Font Selected : </span>
                    <span>
                        <?php if($current_items['wca_trenchcoat_embroidery_font'] == "1"){
                        $img = "19";}
