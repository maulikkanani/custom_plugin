<script type="text/javascript">
    ...
    jQuery(document).on('click', '.process_status', function() {
        ...
        jQuery.ajax({
            url: ajax_url,
            type: "POST",
            data: {action:'active_zipper', row_id: row_id,master_id: master_id},
...
$columns = array(
    'name' => array('lable' => 'Zipper Name', 'sort' => true, 'DefaultShort' => true, 'Sort_order' => 'ASC'),
...
function CreteList($item, $column_name) {
    ...
    switch ($column_name):
        case 'active':
            ...
            $data= wca_zippers::get_single_row($item['id']);
