...
<script>
    ...
    jQuery(document).ready(function() {
        ...
        jQuery('#fileupload').bind('fileuploadsubmit', function(e, data) {
            ...
            data.formData = {action: 'upload_button_hilo_image', id: row_id, image_name: jQuery('.image_name').val()};
        });
        ...
        jQuery(document).on('click', '.delete_image', function() {
            ...
            var side = jQuery(this).data('side');
                jQuery.ajax({
                    url: ajax_url,
                    type: "POST",
                    data: {action:'delete_button_hilo_image',img_id:img_id,master_id:master_id,row_id:row_id,side:side},
...
<div class="wrap">
    ...
    <h2 class="shape-wrap">Button hilo Images <a class="add-new-h2" href="admin.php?page=<?php echo $CurrentPage; ?>">Back</a>
        </h2>
</div>
<div class="container">
