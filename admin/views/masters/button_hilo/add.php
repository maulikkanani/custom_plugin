        ...
        <div class="col-sm-8">
            <form class="form-horizontal" method="POST">
                <div class="form-group">
                    <div class="form-group">
                        <label for="inputEmail3" class="col-sm-3 control-label">Button hilo Name:</label>
                        <div class="col-sm-3">
                            <input type="text" name="name" class="input_same" placeholder="Button hilo name">
                        </div>         
                    </div>

                    <div class="form-group">
                        <label for="inputEmail3" class="col-sm-3 control-label">Button hilo Color:</label>
                        <div class="col-sm-3">
                            <input type="text" name="color" class="input_same" placeholder="Button hilo color">
                        </div>         
                    </div>
