...
$master_id = '3';
$form_name = "Button hilo";
$table = BUTTON_HILO;
$cbid = 'button_hilo_id';
$header_botton = 'Add Button Hilo';
...
include ABS_WCA . "admin/views/masters/button_hilo/grid.php";
...
if (isset($_POST['submit']) && $_POST['submit'] == 'Update'):
    $button_hilo_id = mysql_real_escape_string($_GET['id']);
    wca_button_hilo::save($button_hilo_id);
...
if ($Buttons_grid->current_action() == 'dodelete'):
     if($_POST['delete_option']=='delete'){
             $button_hilo_ids=array_map('mysql_real_escape_string', $_REQUEST[$cbid]);   
             wca_button_hilo::delete_multiple($button_hilo_ids);
     }
...
if ($Buttons_grid->current_action() == 'edit'):
    ...
    <?php
    $button_hilo_id = mysql_real_escape_string($_GET['id']);
    $data = wca_button_hilo::get_single_row($button_hilo_id);
    $form_button = 'Update';
    $default_values = json_encode($data);
    include ABS_WCA . "admin/views/masters/button_hilo/add.php";
    exit;
endif;
...
if ($Buttons_grid->current_action() == "add") {
    $form_titel = "Add new button hilo";
    $form_button = 'Add';
    $default_values = '[]';
    ?>
    <div class="wrap">
...
if ($Buttons_grid->current_action() == "image_add") {
    include ABS_WCA . "admin/views/masters/button_hilo/image_add.php";
    exit;
}
...
if ($Buttons_grid->current_action()== 'delete'){
    include ABS_WCA . "admin/views/masters/button_hilo/delete.php";
    exit;
}
/*End:- delete form */
?>
