...
include ABS_WCA . "admin/views/masters/fabrics/grid.php";
...
if ($Buttons_grid->current_action() == "image_add") {
    include ABS_WCA . "admin/views/masters/fabrics/image_add.php";
    exit;
}
...
if ($Buttons_grid->current_action()== 'delete'){
    include ABS_WCA . "admin/views/masters/fabrics/delete.php";
    exit;
}
/*End:- delete form */
?>
