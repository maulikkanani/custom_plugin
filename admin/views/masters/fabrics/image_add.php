...
<script>
    ...
    jQuery(document).ready(function() {
        ...
        jQuery('#fileupload').bind('fileuploadsubmit', function(e, data) {
            ...
            data.formData = {action: 'upload_fabric_image', id: row_id, image_name: jQuery('.image_name').val()};
        });
        ...
        jQuery(document).on('click', '.delete_image', function() {
            ...
            var side = jQuery(this).data('side');
                jQuery.ajax({
                    url: ajax_url,
                    type: "POST",
                    data: {action:'delete_fabric_image',img_id:img_id,master_id:master_id,row_id:row_id,side:side},
