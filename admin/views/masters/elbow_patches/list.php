...
$master_id = '8';
$form_name = "Elbow Patches";
$table = ELBOW_PATCHES;
$cbid = 'elbow_patches_id';
$header_botton = 'Add Elbow Patches';
...
include ABS_WCA . "admin/views/masters/elbow_patches/grid.php";
...
if (isset($_POST['submit']) && $_POST['submit'] == 'Update'):
    $elbow_patches_id = mysql_real_escape_string($_GET['id']);
    wca_elbow_patches::save($elbow_patches_id);
...
if ($Buttons_grid->current_action() == 'dodelete'):
     if($_POST['delete_option']=='delete'){
             $elbow_patches_ids=array_map('mysql_real_escape_string', $_REQUEST[$cbid]);   
             wca_elbow_patches::delete_multiple($elbow_patches_ids);
     }
...
if ($Buttons_grid->current_action() == 'edit'):
    ...
    <?php
    $elbow_patches_id = mysql_real_escape_string($_GET['id']);
    $data = wca_elbow_patches::get_single_row($elbow_patches_id);
    $form_button = 'Update';
    $default_values = json_encode($data);
    include ABS_WCA . "admin/views/masters/elbow_patches/add.php";
    exit;
endif;
...
if ($Buttons_grid->current_action() == "add") {
    $form_titel = "Add new elbow Patches";
    $form_button = 'Add';
    $default_values = '[]';
    ?>
    <div class="wrap">
...
if ($Buttons_grid->current_action() == "image_add") {
    include ABS_WCA . "admin/views/masters/elbow_patches/image_add.php";
    exit;
}
...
if ($Buttons_grid->current_action()== 'delete'){
    include ABS_WCA . "admin/views/masters/elbow_patches/delete.php";
    exit;
}
/*End:- delete form */
?>
