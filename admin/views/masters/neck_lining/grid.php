<script type="text/javascript">
    ...
    jQuery(document).on('click', '.process_status', function() {
        ...
        jQuery.ajax({
            url: ajax_url,
            type: "POST",
            data: {action:'active_neck_lining', row_id: row_id,master_id: master_id},
...
$columns = array(
    'name' => array('lable' => 'Neck Lining Name', 'sort' => true, 'DefaultShort' => true, 'Sort_order' => 'ASC'),
...
function CreteList($item, $column_name) {
    ...
    switch ($column_name):
        ...
        case 'icon':
                $icon_path="$category_dir/neck_lining/$item[id]/neck_lining_icon.jpg";
                if(file_exists($icon_path))
                    echo "<img src='$category_url/neck_lining/$item[id]/neck_lining_icon.jpg' style='width: 25px;'>";        
        break;
        ...
        case 'active':
            ...
            $data= wca_neck_lining::get_single_row($item['id']);
