...
<style type="text/css">
    ...
    .wca_cusustome  .gbtr_poduct_details_right_col{
            ...
            <div itemscope itemtype="http://schema.org/Product" id="product-<?php the_ID(); ?>" <?php post_class(); ?>>	
                    ...
                    if ($i >= 1) {
                        ...
                        <div class="product_navigation mobiles">
                            ...
                            if (strlen($term_list) > 0) {
                                echo '<div class="nav-back">&lsaquo;&nbsp;&nbsp;&nbsp;' . __('Back to ', 'theretailer') . $term_list . '</div>';
                            };
                            ?>
                ...
                ");
                    ...
                    <div class="gbtr_poduct_details_left_col">
                         ...
                         */
                          wca_get_template_part('image-layer.php');
                         //wca_get_template_part('single-product/product-image.php' );
                    ...
                    <div class="gbtr_poduct_details_right_col">
                        ...
                        if ($i >= 1) {
                            ...
                            <div class="product_navigation desktops summary">
